...
MESSAGES = [
    "Привіт, {name}. Що ти зараз відчуваєш?",
    "{name}, привіт. Які почуття в тебе просто зараз?",
    "Привіт. Зупинись на секунду — що ти зараз відчуваєш?",
    "{name}, що зараз всередині?",
    "Привіт, {name}. Назви одним словом, що відчуваєш зараз.",
    "Що ти відчуваєш цієї хвилини, {name}?",
    "{name}, привіт. Яке почуття зараз найсильніше?",
    "Привіт. Як ти зараз почуваєшся?",
    "{name}, що відбувається всередині просто зараз?",
    "Привіт, {name}. Що відчуваєш у цей момент?",
]
